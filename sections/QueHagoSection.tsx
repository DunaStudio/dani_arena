        ...
        <div className="flex items-start gap-20">
          <div className="flex-1 flex flex-col shrink-0">
            ...
            <h2 className="text-charcoal text-[48px] font-medium leading-[1.2] mt-4">
              La imagen como un lenguaje completo
            </h2>
          </div>
          <div className="flex-1 flex flex-col gap-5 pt-2">
            <p className="text-charcoal opacity-70 font-light text-base">
              No se trata solo de cómo te vestís, sino de cómo comunicás, te
              expresás y te posicionás. A través de un enfoque integral, acompaño
              procesos donde se alinean la identidad, la comunicación y la
              presencia.
            </p>
            <p className="text-charcoal opacity-70 font-light text-base">
        ...
        <div className="grid grid-cols-3 gap-5">
          {cards.map((card) => (
            ...
            >
              ...
              <p className="text-charcoal font-medium text-[28px]">
                {card.title}
              </p>
