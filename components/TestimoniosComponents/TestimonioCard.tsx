...
export default function TestimonioCard({
  ...
  return (
    <div
      className="shrink-0 w-[82vw] md:w-72 bg-white rounded-[5px] p-6 md:p-7 flex flex-col justify-between gap-4 md:gap-10"
      style={{ minHeight: "260px" }}
    >
      <p className="text-charcoal text-sm lg:text-base leading-relaxed font-light">
        "{testimony}"
      </p>
